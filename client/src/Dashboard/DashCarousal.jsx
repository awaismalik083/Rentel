...
const Card = ({ image, price }) => {
  return (
    <div className="relative bg-white w-72 sm:w-80 rounded-xl shadow-md overflow-hidden flex-shrink-0 group">
      {/* Image Section */}
...
const DashCarousal = () => {
  ...
  return (
    <div className="w-full min-h-[280px] ml-[10rem] flex justify-center items-center p-4 bg-gray-100 rounded-xl">
      <div className="flex items-center gap-4 max-w-[100vw] md:max-w-[90rem]">
        {/* Left Arrow */}
        <button
          onClick={() => scroll('left')}
          className="text-red-700 hover:scale-110 transition p-1 md:p-2"
        ...
        <div
          ref={scrollRef}
          className="flex gap-6 overflow-x-auto scrollbar-hide snap-x snap-mandatory px-2"
